...
const translations = {
    bg: {
        ...
        // Hero Section
        'hero.badge': 'Професионални IT решения',
        'hero.title': 'Разработка на',
        'hero.title.highlight': 'Софтуер',
        'hero.description':
            'Комплексни IT услуги: разработка на уеб приложения, мобилни приложения, системи за сигурност и информационни технологии за вашия бизнес.',
        ...
        'services.description':
            'Професионални IT решения и експертни технологии за развитие на вашия бизнес',
        'services.web.title': 'Уеб разработка',
        'services.web.description':
            'Създаване на модерни уеб приложения и сайтове с използване на най-новите технологии. От корпоративни портали до онлайн магазини.',
        'services.mobile.title': 'Мобилна разработка',
        'services.mobile.description':
            'Разработка на нативни и кроссплатформени мобилни приложения за iOS и Android с модерен UX/UI дизайн.',
        'services.security.title': 'Информационна сигурност',
        'services.security.description':
            'Комплексни решения за защита на информацията, одит на сигурността, внедряване на системи за защита на данни и съответствие със стандартите за сигурност.',
        'services.technologies': 'Технологии:',
        'services.included': 'Какво е включено:',
        'services.additional.title': 'Допълнителни услуги',
        'services.additional.description':
            'Специализирани технологии и услуги за развитие на вашия IT проект',
        'services.database': 'Бази данни',
        'services.database.desc': 'Проектиране и оптимизация на бази данни.',
        'services.cloud': 'Облачни решения',
        'services.cloud.desc': 'Миграция и разгръщане в облака.',
        'services.devops': 'DevOps',
        'services.devops.desc': 'Автоматизация на разгръщането и мониторинг.',
        'services.support': 'Техническа поддръжка',
        'services.support.desc': 'Денонощна поддръжка на вашите IT системи.',
        'services.design': 'UI/UX Дизайн',
        'services.design.desc': 'Модерен дизайн на потребителски интерфейси.',
        'services.blockchain': 'Блокчейн',
        'services.blockchain.desc':
            'Разработка на децентрализирани приложения.',

        // Blog Section
        'blog.title': 'Блог и статии',
        'blog.description':
            'Експертни знания, технически съвети и прозрения от нашия екип от професионалисти',

        // Projects Section
        'projects.title': 'Нашите проекти',
        'projects.description':
            'Някои от най-успешните ни IT проекти и разработки',

        // Testimonials Section
        'testimonials.title': 'Отзиви от нашите клиенти',
        'testimonials.description':
            'Научете какво казват нашите доволни клиенти за сътрудничеството с нас',

        // FAQ Section
        'faq.title': 'Често задавани въпроси',
        'faq.description':
            'Популярни въпроси за нашите услуги и процеса на разработка',

        // Contact Section
        'contact.title': 'Свържете се с нас',
        'contact.description':
            'Попълнете формата по-долу, за да обсъдим вашия проект. Нашият екип ще се свърже с вас в рамките на 24 часа за обсъждане на детайлите.',
        'contact.name': 'Име',
        'contact.email': 'Електронна поща',
        'contact.phone': 'Телефон',
        'contact.company': 'Компания',
        'contact.project': 'Описание на проекта',
        'contact.project.placeholder':
            'Опишете вашия проект, изисквания и пожелания',
        'contact.submit': 'Изпратете заявка',
        'contact.direct.title': 'Трябва да говорите директно с нас?',
        'contact.direct.description':
            'Ако имате специфични въпроси или предпочитате да обсъдите изискванията си по телефона, нашият екип е тук, за да помогне.',

        'contact.time': 'Пн-Пт: 9:00-18:00 | Сб: 10:00-16:00',
        'contact.text.title': 'Спешна поддръжка',
        'contact.text.description':
            'Денонощна линия за поддръжка за съществуващи резервации',
        'contact.text.title2': 'Индивидуални пакети',
        'contact.text.description2':
            'Предлагаме индивидуални пакети услуги за бизнеса, които включват разработка, поддръжка и консултации.',
        'contact.text.title3': 'Поддръжка на клиенти',
        'contact.text.description3':
            'Нашият екип за поддръжка винаги е готов да ви помогне с всякакви въпроси или проблеми, свързани с вашите IT системи.',
        // Footer
        'footer.description':
            'Професионални услуги за разработка на софтуер, информационни технологии и системи за сигурност за вашия бизнес.',
        'footer.links': 'Бързи връзки',
        'footer.contact.info': 'Контактна информация',
        ...
        'blog.post.web.title': 'Модерни тенденции в уеб разработката 2024',
        'blog.post.web.excerpt':
            'Преглед на най-новите технологии и фреймуърци за създаване на модерни уеб приложения, включително React 18, Next.js 14 и TypeScript.',
        'blog.post.web.category': 'Уеб разработка',
        'blog.post.mobile.title': 'Безопасност на мобилните приложения',
        'blog.post.mobile.excerpt':
            'Най-добри практики за осигуряване на безопасност на мобилните приложения и защита на потребителските данни.',
        'blog.post.mobile.category': 'Безопасност',
        'blog.post.cloud.title': 'Облачни технологии за бизнеса',
        'blog.post.cloud.excerpt':
            'Как облачните решения могат да оптимизират бизнес процесите и да намалят IT разходите на компанията.',
        'blog.post.cloud.category': 'Облачни технологии',
        'blog.post.devops.title': 'DevOps: автоматизация на внедряването',
        'blog.post.devops.excerpt':
            'Внедряване на CI/CD пайплайни и автоматизация на процесите за внедряване за повишаване на ефективността на разработката.',
        'blog.post.devops.category': 'DevOps',
        'blog.post.design.title': 'UI/UX дизайн: тенденции 2024',
        'blog.post.design.excerpt':
            'Модерни подходи за проектиране на потребителски интерфейси и създаване на удобно потребителско изживяване.',
        ...
        'projects.ecommerce.description':
            'Пълнофункционална платформа за електронна търговия с интеграция на платежни системи, система за управление на поръчки и аналитика.',
        'projects.ecommerce.category': 'Уеб платформа',
        'projects.banking.title': 'Мобилен банкинг FinanceApp',
        'projects.banking.description':
            'Сигурно мобилно приложение за банкови операции с биометрична автентификация и криптиране на данни.',
        'projects.banking.category': 'Мобилно приложение',
        'projects.security.title':
            'Корпоративна система за безопасност SecureNet',
        'projects.security.description':
            'Комплексна система за информационна безопасност с многофакторна автентификация, мониторинг на заплахи и защита от кибератаки.',
        'projects.security.category': 'Система за безопасност',

        // FAQ Section - questions and answers
        'faq.q1.question': 'Колко време отнема разработката на уеб приложение?',
        'faq.q1.answer':
            'Времето за разработка зависи от сложността на проекта. Прост сайт - 2-4 седмици, сложно уеб приложение - 3-6 месеца. Предоставяме подробен план с времеви рамки след анализ на изискванията.',
        'faq.q2.question': 'Какви технологии използвате?',
        'faq.q2.answer':
            'Работим с модерни технологии: React, Vue.js, Node.js, Python, PHP, React Native, Flutter. Изборът на технологии зависи от спецификата на проекта и вашите изисквания.',
        'faq.q3.question': 'Предоставяте ли техническа поддръжка?',
        'faq.q3.answer':
            'Да, предоставяме техническа поддръжка и съпровождане на проекти. Включва поправяне на грешки, актуализации, консултации и развитие на функционалност.',
        'faq.q4.question': 'Как се осигурява безопасността на данните?',
        'faq.q4.answer':
            'Използваме модерни методи за криптиране, SSL сертификати, защитени API, редовни одити за безопасност и спазваме стандартите GDPR и ISO 27001.',
        'faq.q5.question':
            'Може ли да се правят промени по време на разработката?',
        'faq.q5.answer':
            'Да, използваме гъвкава методология за разработка, която позволява внасяне на промени. Обсъждаме всички корекции и тяхното влияние върху сроковете и бюджета.',
        'faq.q6.question': 'Каква е цената на разработката?',
        'faq.q6.answer':
            'Цената зависи от сложността на проекта, функционалността и сроковете. Предоставяме безплатна консултация и подробна оферта след анализ на вашите изисквания.',

        // Testimonials Section - specific testimonials
        'testimonials.client1.name': 'Иван Петров',
        'testimonials.client1.position': 'Изпълнителен директор',
        'testimonials.client1.company': 'ТехИновации',
        'testimonials.client1.testimonial':
            'Екипът на Integral Revolut създаде отлична CRM система за нас. Професионален подход и качествена техническа поддръжка!',
        'testimonials.client2.name': 'Мария Иванова',
        'testimonials.client2.position': 'IT Директор',
        'testimonials.client2.company': 'Креативни Решения',
        'testimonials.client2.testimonial':
            'Мобилното приложение надмина всички очаквания. Модерен дизайн, бърза производителност и отлична сигурност на данните.',
        'testimonials.client3.name': 'Алексей Сидоров',
        'testimonials.client3.position': 'Проектен мениджър',
        'testimonials.client3.company': 'Бъдещи Технологии',
        'testimonials.client3.testimonial':
            'Препоръчвам за всякакви IT проекти! Спазване на срокове, прозрачност на процеса и високо качество на кода.',
    },
    uk: {
        // Navigation
        'nav.home': 'Головна',
